...
import {
  ConnectedPositioningStrategy, IgxDropDownComponent, IgxInputGroupComponent, ISelectionEventArgs, HorizontalAlignment
} from "igniteui-angular";
import { Dictionary } from 'src/app/shared/types/survey.type';


@Component({
  selector: "aon-jobs-dropdown",
  templateUrl: "./jobs-dropdown.component.html",
  styleUrls: ["./jobs-dropdown.component.scss"]
})

export class JobsDropDownComponent implements OnInit {
